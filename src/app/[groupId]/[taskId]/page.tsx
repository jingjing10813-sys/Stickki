  ...
  return (
    ...
    >
      ...
      <header className="flex-shrink-0 flex items-center justify-between px-5 pb-4">
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" stroke="#FF6B6B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10 11v6M14 11v6" stroke="#FF6B6B" strokeWidth="1.5" strokeLinecap="round"/>
          </svg>
        </motion.button>
      </header>
