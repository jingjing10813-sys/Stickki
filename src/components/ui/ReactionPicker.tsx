    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ background: "rgba(107,114,128,0.2)", backdropFilter: "blur(7.3px)", WebkitBackdropFilter: "blur(7.3px)" }}
        />
        <div
        ...
        >
          {EMOJIS.map((emoji, i) => (
            <motion.button
              ...
              className="w-9 h-9 flex items-center justify-center text-xl rounded-full hover:bg-white/20 transition-colors"
            >
              {emoji}
            </motion.button>
          ))}
          ...
          {/* 구분선 */}
          <div className="w-px h-6 mx-1 rounded-full" style={{ backgroundColor: "rgba(255,255,255,0.3)" }} />
          ...
          {onTogglePin && (
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill={isPinned ? "#FFD700" : "none"} stroke={isPinned ? "#FFD700" : "rgba(255,255,255,0.85)"} strokeWidth="2" strokeLinejoin="round">
